...
function (_React$Component) {
  ...
  function Index() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "_moveDown", function () {
      ...
      var nextStepValues = [].concat(newAllowedFigures);
      nextStepValues[currentFigure] = nextStepValues[currentFigure].map(function (item) {
        return item.map(function (figure) {
          return figure + 10;
        });
      });

      if (lodash__WEBPACK_IMPORTED_MODULE_8___default.a.intersection(nextStepValues[currentFigure][activeFigureIndex], _incativeBottom).length > 0 || lodash__WEBPACK_IMPORTED_MODULE_8___default.a.intersection(nextStepValues[currentFigure][activeFigureIndex], bottomStructure).length > 0) {
        var newBottomStructure = bottomStructure;
        newBottomStructure.push(newAllowedFigures[currentFigure][activeFigureIndex]);

        _this.setState({
          bottomStructure: newBottomStructure.flat()
        });
...
//# sourceMappingURL=index.js.792393da74a7c40951cb.hot-update.js.map