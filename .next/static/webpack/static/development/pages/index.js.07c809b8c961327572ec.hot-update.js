...
function (_React$Component) {
  ...
  function Index() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "_moveLeft", function () {
      ...
      if (lodash__WEBPACK_IMPORTED_MODULE_8___default.a.intersection(newAllowedFigures[activeFigureIndex], _incatives).length > 0) {
        return false;
      }
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "_moveDown", function () {
      ...
      if (lodash__WEBPACK_IMPORTED_MODULE_8___default.a.intersection(newAllowedFigures[activeFigureIndex], _incativeBottom).length > 0 || lodash__WEBPACK_IMPORTED_MODULE_8___default.a.intersection(newAllowedFigures[activeFigureIndex], bottomStructure).length > 0) {
        var newBottomStructure = [].concat(bottomStructure);
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "_checkLine", function () {
      ...
      filledLineMarker.map(function (item) {
        if (item.every(function (elem) {
          ...
          var _newBottomStructure = [].concat(_newBottomStructure.filter(function (el) {
            return !item.includes(el);
          }));

          _newBottomStructure = _newBottomStructure.map(function (block) {
            return block + 10;
          });

          _this.setState({
            bottomStructure: _newBottomStructure,
            score: score + 1
          });
        }
      });
...
//# sourceMappingURL=index.js.07c809b8c961327572ec.hot-update.js.map